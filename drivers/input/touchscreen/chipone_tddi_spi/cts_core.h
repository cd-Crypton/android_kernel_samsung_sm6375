...
enum cts_dev_hw_reg {
    ...
    defined(CONFIG_CTS_ICTYPE_ICNL9951R)
...
struct cts_device_touch_info {
	...
	u8 proximity;
    u8 palm_major; // high 7 bits
    u8 palm_minor; // high 7 bits
	u8 palm_flags; // bit 0

	u8 stylus_num_msg:4;
	u8 stylus_version:4;
	struct cts_device_stylus_msg stylus_msgs[CFG_CTS_MAX_STYLUS_NUM];
